    ...
    for index, e in enumerate(restaurant_elements, start=1):
        ...
        try:
            ...
            try:
                ...
                # 옵션 정보 (미쉐린, 착한가격 등)
                option = safe_get_text(title, './div[2]/div[@class="XtBbS"]')
            ...
            try:
                try:
                    ...
                    tv_box = driver.find_element(By.XPATH, '//div[@class="PIbes"]/div[(@class="O8qbU TMK4W")]')
                ...
                if tv_box:
                    ...
                    if not tv_text or all(span.text.strip() == '' for span in tv_text):
                        tv_text = tv_box.find_element(By.XPATH,
                                                      './/div[@class="vV_z_"]//div[@class="w9QyJ"]/span[@class="A_cdD"]')
                        broad_text = tv_text.text
                        if broad_text:
